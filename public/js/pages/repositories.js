...
function renderReposGrid() {
  ...
  _repos.forEach(function(repo) {
    ...
    card.setAttribute('data-id', repo.id || repoName);
    ...
    var html =
      ...
      '<div style="display:flex;align-items:center;justify-content:space-between;border-top:1px solid var(--color-border);padding-top:14px;margin-top:10px;">' +
        ...
        '<div style="position:relative;">' +
          '<button onclick="toggleRepoMenu(\'' + (repo.id || repoName) + '\', event)" class="btn-manage-repo" style="padding:6px 12px;background:transparent;border:1px solid var(--color-border);border-radius:8px;font-size:12px;font-weight:600;color:var(--color-text-primary);cursor:pointer;display:flex;align-items:center;gap:6px;">' +
          ...
          '</button>' +
          '<div id="repo-menu-' + (repo.id || repoName) + '" class="repo-dropdown-menu" style="display:none;">' +
            '<div onclick="promptDisconnectRepo(\'' + (repo.id || repoName) + '\')" class="repo-dropdown-item">' +
            ...
            '<div onclick="promptDeleteRepo(\'' + (repo.id || repoName) + '\')" class="repo-dropdown-item">' +
