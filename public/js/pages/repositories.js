...
function isPrivilegedUser() {
  var u = window.__USER__ || (typeof auth !== 'undefined' && auth.getUser ? auth.getUser() : null);
  var role = (u && (u.userType || u.role || '')) ? (u.userType || u.role).toLowerCase() : '';
  return ['super_admin', 'devops', 'admin'].indexOf(role) !== -1;
}
...
function renderReposGrid() {
  ...
  _repos.forEach(function(repo) {
    ...
    var manageBtnHtml = isPrivileged ?
